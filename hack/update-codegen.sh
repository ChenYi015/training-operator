...
cd ${SCRIPT_ROOT}
echo "Generating client,lister,informer for tensorflow/v1"
...
$(go env GOPATH)/bin/defaulter-gen --input-dirs github.com/kubeflow/tf-operator/pkg/apis/tensorflow/v1 \
...
./openapi-gen --input-dirs github.com/kubeflow/tf-operator/pkg/apis/tensorflow/v1 \
