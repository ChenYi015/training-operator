...
func TestCreatePods(t *testing.T) {
	...
	body := runtime.EncodeOrDie(testapi.Default.Codec(), &corev1.Pod{ObjectMeta: metav1.ObjectMeta{Name: "empty_pod"}})
	...
	clientset := clientset.NewForConfigOrDie(&restclient.Config{Host: testServer.URL, ContentConfig: restclient.ContentConfig{GroupVersion: &corev1.SchemeGroupVersion}})
